...
public class TabMockEmployee extends JPanel {
	 ...
	 * @param title
	 */
	public TabMockEmployee(Color color, String title) {
		///////////////////////// LABEL///////////////////////////////////////////////
		/**
		 * Definition of labelNbGenerate
		 */
		policeLabel = new Font("Arial", Font.BOLD, 20);
		labelNbGenerate = new JLabel("Number employee to generate : ");
			...
			public void actionPerformed(ActionEvent e) {
				if (textInputNbGenerate.getText().trim().equals("")) {
					...
					if (textInputNbGenerate.getText().trim().matches("[0-9]+[0-9]*")) {
						generateEmployee = new GenerateEmployee(Integer.parseInt(textInputNbGenerate.getText().trim()));
